  ...
  return (
    ...
    <ProgressBar isVisible={success} />
      ...
      <div className="heading text-[1.5em]  m-auto flex flex-col items-center justify-center font-bold text-center">
        ...
        <p className="font-light  text-[#787878] text-[0.8em] text-center justify-center align-middle">Are you sure you want to send the user a link to reset the password?</p>
      </div>

      <div className="form flex flex-col p-4">
      
          <span
            className="w-full font-bold text-center rounded-lg mb-4 focus:outline-none focus:border-[#7F56D9]"
         ...
         <button
            type="submit"
            className="bg-[#7F56D9] text-white text-[1.4em] w-full p-2 hover:bg-[#5c35af] rounded-xl m-auto "
          >
            Send
          </button>
