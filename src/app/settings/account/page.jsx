    ...
    <div className='relative'>
      ...
      <div className="firstname flex flex-col px-4 rounded-lg border m-4 mt-1 min-w-[4em] max-w-[40%]">
        ...
        {isEditingFirstName ? (
          <input
            ...
            autoFocus
            className='foccus:outline-none'
          />
        ) : (
          <span className="text-[1.2em]" onClick={handleFirstNameEdit}>
            {firstName}
          </span>
        )}
      </div>
      <div className="lastname flex flex-col px-4 rounded-lg border m-4 min-w-[4em] max-w-[40%]">
        ...
        {isEditingLastName ? (
          ...
          <span className="text-[1.2em]" onClick={handleLastNameEdit}>
            {lastName}
          </span>
        )}
      </div>
      ...
      <div className="personal-info">
        <h1 className='text-2xl font-semibold font-press-start m-4 mt-8 mb-1'>Personal Information</h1>
        <div className="info flex flex-col">
          <div className="email flex flex-col px-4 rounded-lg border m-4 mt-1 min-w-[4em] max-w-[40%]" onClick={showeditmail}>
