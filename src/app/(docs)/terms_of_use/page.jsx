...
const TermsOfUse = () => {
  return (
    <div className="min-h-screen bg-gray-100 leading-5">
      ...
      <div className="body p-8 leading-7">
        {/* Table of Contents */}
        <div class="bg-[#f5f7ffda] rounded-lg shadow-lg p-6 mb-8">
    ...
    <li class="cursor-pointer m-3 hover:text-[#7F56D9]">
      <Link href="#section27">CONTACT US</Link>
        ...
        <div className=" p-8 mt-8">
          {/* Section 1 */}
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8" id="section1">
            ...
            <p>
              We are registered in Canada and have our registered office at 637
              Lake Shore Blvd W, Toronto, Ontario M5V3J6.
            </p>

            <p className="underline font-bold mt-8">Agreement to the Terms</p>
            <p>
            ...
            <p className="underline font-bold mt-8">Updates and Changes</p>
            <p>
            ...
            <p className="underline font-bold mt-8">
            ...
            <p className="underline font-bold mt-8">Age Requirement</p>
            <p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8" id="section2">
            <h2 className="text-3xl font-bold mb-8 text-center">
            ...
            <p className="font-bold underline mt-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8" id="section3">
            <h2 className="text-3xl font-bold mb-8 text-center">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8" id="section4">
            <h2 className="text-3xl font-bold mb-8 text-center">
              USER REGISTRATION
            </h2>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8" id="section5">
            <h2 className="text-3xl font-bold mb-8 text-center">
              FEES AND PAYMENT
            </h2>
            ...
            <p>
              We bill you through an online billing account for purchases made
              via the Site. Sales tax will be added to the price of purchases as
              deemed required by us. We may change prices at any time. All
              payments shall be in Canadian Dollars.
            </p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8" id="section6">
            <h2 className="text-3xl font-bold mb-8 text-center">
              CANCELLATION
            </h2>
            ...
            <p>
              ...
              at any time by contacting us using the contact information
            ...
            <p>
              ...
              <a href="mailto:support@nuggetdata.net">support@nuggetdata.net</a>
              .
            </p>
          </div>

          <div className="bg-white rounded-lg shadow-lg p-8 mb-8" id="section7">
            <h2 className="text-3xl font-bold mb-8 text-center">
            ...
            <ul className="list-disc px-8 gap-8">
              <li>
              ...
              <li>Engage in web scraping activities.</li>
              <li>
                Use the Site to advertise or offer to sell goods and services.
              </li>
              <li>Sell or otherwise transfer your profile.</li>
              <li>Share data outside of their organization.</li>
              <li>Share login information.</li>
            </ul>
          </div>

          <div className="bg-white rounded-lg shadow-lg p-8 mb-8" id="section8">
            <h2 className="text-3xl font-bold mb-8 text-center">
              USER GENERATED CONTRIBUTIONS
            </h2>

            <p className="justify-center p-2 font-semibold">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8" id="section9">
            <h2 className="text-3xl font-bold mb-8 text-center">
          ...
          <div
            ...
            id="section10"
          >
            <h2 className="text-3xl font-bold mb-8 text-center">SUBMISSIONS</h2>
          ...
          >
            ...
            <p className="mb-4">
              ...
              12.211 (for technical data).
            </p>
            <p className="mb-4">
              If our services are acquired by or on behalf of any agency within
          ...
          >
            ...
            <p>
              ...
              Canada. Leslieville Development Group LTD and yourself irrevocably
          ...
          >
            ...
            <p>
              <strong className="text-[1.2em] mt-4">
            ...
            <p>
              <strong className="text-[1.2em] mt-4">Binding Arbitration</strong>
            </p>
            <p>
              ...
              place, of arbitration shall be Toronto, Canada. The language to be
            ...
            <p>
              <strong className="text-[1.2em] mt-4">Restrictions</strong>
            </p>
            <p>
          ...
          <div
            ...
            id="section19"
          >
            <h2 className="text-3xl font-bold mb-8 text-center">CORRECTIONS</h2>
          ...
          <div
            ...
            id="section20"
          >
            <h2 className="text-3xl font-bold mb-8 text-center">DISCLAIMER</h2>

            <p className="text-lg">
              <em className="font-bold">
                THE SITE IS PROVIDED ON AN "AS-IS" AND "AS-AVAILABLE" BASIS.
              </em>{" "}
              You agree that your use of the Site and our services will be at
            ...
            <p className="text-lg">
              <em className="font-bold">PERSONAL INJURY OR PROPERTY DAMAGE.</em>{" "}
              We will not be liable for any personal injury or property damage,
              of any nature whatsoever, resulting from your access to and use of
              the Site. You are responsible for any unauthorized access to or
              use of our secure servers and/or any and all personal information
              and/or financial information stored therein.
            </p>

            <p className="text-lg">
              <em className="font-bold">INTERRUPTIONS AND VIRUSES.</em> We
              cannot guarantee the Site will be available at all times. We may
              experience interruptions, delays, or errors due to hardware,
              software, or other technical issues. We will not be liable for any
              bugs, viruses, Trojan horses, or the like transmitted to or
              through the Site by any third party.
            </p>

            <p className="text-lg">
              <em className="font-bold">THIRD-PARTY PRODUCTS AND SERVICES.</em>{" "}
              We do not endorse, guarantee, or assume responsibility for any
              product or service offered by a third party through the Site. Any
              transaction you make with third-party providers of products or
              services is solely between you and the third party, and we will
              not be a party to or responsible for such transactions.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-lg">
              ...
              This includes lost profit, lost revenue, loss of data, or other
              damages arising from your use of the Site, even if we have been
              advised of the possibility of such damages.
            </p>

            <p className="text-lg">
              <em className="font-bold">LIMITED LIABILITY.</em> Notwithstanding
            ...
            <p className="text-lg">
              <em className="font-bold">ADDITIONAL RIGHTS.</em> Certain US state
              laws and international laws may not allow limitations on implied
          ...
          >
            ...
            <ol className="list-decimal list-inside text-lg pl-4 mb-6">
              <li className="mb-4">Use of the Site;</li>
              <li className="mb-4">Breach of these Terms of Use;</li>
              <li className="mb-4">
          ...
          <div
            ...
            id="section23"
          >
            <h2 className="text-3xl font-bold mb-8 text-center">USER DATA</h2>
          ...
          <div class="bg-white rounded-lg shadow-lg p-6 mb-8" id="section26">
            <h2 class="text-3xl font-bold mb-6 text-center">MISCELLANEOUS</h2>
          ...
          <div class="bg-white rounded-lg shadow-lg p-6 mb-8" id="section27">
            ...
            <div class="mt-4">
              <p class="text-lg leading-7 font-semibold">
                Leslieville Development Group LTD
              </p>
              <p class="text-lg leading-7">637 Lake Shore Blvd W</p>
              <p class="text-lg leading-7">Toronto, Ontario M5V 3J6</p>
              <p class="text-lg leading-7">Canada</p>
